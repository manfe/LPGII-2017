        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading"><h1>Edição de Categoria</h1></div>

                    <div class="row">
                        <div class="col-md-12">
                            <div class="content-section mt-20">
                                
                                {!! Form::open(['method' => 'PUT', 'route' => array('categories.update', $category)]) !!}
                                    <div class="form-group row">
                                        {!! Form::label('nome', 'Nome', ['class' => 'col-md-2 col-form-label']) !!}
                                        <div class="col-md-10">
                                            {!! Form::text('nome', $category->nome, ['class' => 'form-control', 'placeholder' => 'Nome da Categoria']) !!}
                                        </div>
                                    </div>
